...
# https://github.com/fatemeh-azadi/PMI-Align/blob/master/aer.py
...
def calculate_metrics(array_sure, array_possible, array_hypothesis, f_alpha, source_sentences=(), target_sentences=(), clean_punctuation=False):
    ...
    # print(len(array_sure), len(array_possible), len(array_hypothesis), len(source_sentences), len(target_sentences))
    # print(array_sure, array_possible, array_hypothesis, source_sentences, target_sentences)
